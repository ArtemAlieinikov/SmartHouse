    ...
    class TelevisionSet : Device, IEnablable, IVolume, IChannelable, IGetChannelList, IAddChannelable, IResetable
    {
        ...
        public IVariable VolumeModule 
        {
            ...
            set
            {
                ...
                {
                    volumeModule = value;
                    InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has changed the volume module.", name));
                }
            }
        }
        ...
        public int VolumeLevel
        {
            ...
            set
            {
                ...
                InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has changed the volume level to {1}.", name, value));
            }
        }
        ...
        public void On()
        {
            ...
            {
                State = true;
                InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has turned on.", name));
            }
            else { }
        }
        public void Off()
        {
            ...
            {
                State = false;
                InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has turned off.", name));
            }
            else { }
        }
        ...
        public void VolumeUp()
        {
            if (VolumeModule.Up())
            {
                InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has changed the volume level to {1}.", name, VolumeLevel));
            }
            else { }
        }
        ...
        public void SetVolume(int number)
        {
            ...
            InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has changed volume level to {1}.", name, number));
        }
        ...
        public void ChannelUp()
        {
            if (ChannelModule.Up())
            {
                InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has changed channel to {1}.", name, ChannelModule.Current));
            }
            else { }
        }
        ...
        public void Reset()
        {
            ...
            channelModule.Reset();
            VolumeModule.Reset();
            InvokeEventStatusChanged(String.Format("Television set: \"{0}\" has reseted.", name));
        }
